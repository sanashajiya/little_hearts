...
class FemaleFollowersScreen extends StatelessWidget {
  final String type; // 'followers' or 'following'

  const FemaleFollowersScreen({super.key, required this.type});
  ...
  Widget build(BuildContext context) {
    ...
    // Dummy data
    final users = [
      {'name': 'Meghana', 'avatar': 'assets/images/story1.png'},
